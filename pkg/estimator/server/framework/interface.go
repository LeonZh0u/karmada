...
type Framework interface {
	...
	RunPreemptionOrderPlugin(ctx context.Context, candidateVictims *map[string]preemptee.CandidateVictim, preemptionRequest *pb.PreemptionRequest) ([]*preemptee.CandidateVictim, *Result)
}
...
type OrderedSortingCriteria func(o1, o2 *preemptee.CandidateVictim) bool
...
type PreemptionOrderPlugin interface {
	...
	SetSortingCriterias(orderedSortingCriterias []OrderedSortingCriteria)
}
